      ...
      <View>
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.comparisonsContainer}>
            ...
            <ComparisonRow compareValue={compareWeekCost || 0} percentageChange={percentageWeekCost} comparisonText="la semana pasada" noDataText="Sin datos de la semana pasada" />
          </View>
        </View>
